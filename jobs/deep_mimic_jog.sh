...
#SBATCH --output=./jobs/deep_mimic_jog.out
#SBATCH --error=./jobs/deep_mimic_jog.err
#SBATCH --gpus=1
...
# run experiment
xvfb-run -a --server-args="-screen 0 480x480x24" /cluster/home/$USER/miniconda3/envs/pylocoEnv/bin/python src/python/main.py -wb -vr -c bob_env_jog.json
