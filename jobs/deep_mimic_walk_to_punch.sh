...
#SBATCH --output=./jobs/deep_mimic_walkpunch.out
#SBATCH --error=./jobs/deep_mimic_walkpunch.err
...
# run experiment
xvfb-run -a --server-args="-screen 0 480x480x24" /cluster/home/$USER/miniconda3/envs/pylocoEnv/bin/python src/python/main.py -wb -vr -c bob_env_walk_to_punch.json
